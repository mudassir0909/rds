    ...
    this.$get = ['Restangular', '$parse', function(Restangular, $parse) {
        ...
        function Resource(name, options) {
            ...
            this.$new = function(attributes) {
                var restangularizedObject = _.clone(attributes);

                Restangular.restangularizeElement(null, restangularizedObject, name);
        ...
        function Record(restangularizedObject, collection) {
            ...
            Restangular.copy(restangularizedObject, this);
